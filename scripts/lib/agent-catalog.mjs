...
export const BUILT_IN_STARTER_TEMPLATES = [
  ...
  {
    kind: 'vaultHealthReport',
    label: 'Vault health report',
    detail: 'Broken links, orphans, tasks, and cleanup priorities',
  ...
  },
  {
    kind: 'savedQuery',
    label: 'Saved query',
    detail: 'Reusable search, task, tag, or vault-health query',
    file: 'Saved Query.md',
    content: lines(
      '---',
      'type: saved-query',
  ...
  {
    kind: 'vaultMaintenanceQueue',
    label: 'Vault maintenance queue',
    detail: 'Triage vault health, cleanup, and repair work',
