...
const api: ForgeAPI = {
  ...
  importAttachmentFiles: (vault, noteRel, files) => ipcRenderer.invoke('file:importAttachmentFiles', vault, noteRel, files),
  importMedia: (vault, sourcePaths) => ipcRenderer.invoke('file:importMedia', vault, sourcePaths),
  importMediaFiles: (vault, files) => ipcRenderer.invoke('file:importMediaFiles', vault, files),
